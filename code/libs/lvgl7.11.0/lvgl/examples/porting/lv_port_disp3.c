...
void lv_port_disp_init(void)
{
    ...
    static LV_MEM_ATTR lv_color_t lcdbuf_gui[LV_HOR_RES_MAX * LV_VER_RES_MAX];  /*A screen sized buffer*/
    static LV_MEM_ATTR lv_color_t lcdbuf_show[LV_HOR_RES_MAX * LV_VER_RES_MAX]; /*An other screen sized buffer*/
    lv_disp_buf_init(&draw_buf_dsc_3, lcdbuf_gui, lcdbuf_show, LV_HOR_RES_MAX * LV_VER_RES_MAX);   /*Initialize the display buffer*/
